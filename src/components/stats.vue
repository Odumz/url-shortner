<template>
  <div class="grid py-28 lg:px-40 px-7 bg-gray bg-opacity-10">
    <h1 class="font-bold text-2xl text-very-dark-violet pb-4">
      Advanced Statistics
    </h1>
    <p
      class="lg:flex hidden text-grayish-violet leading-6 font-semibold lg:justify-center text-sm"
    >
    ...
    <div
      class="relative grid gap-14 lg:flex justify-center lg:justify-between items-start"
    >
      <div
        class="hidden absolute top-72 xl:top-56 2xl:top-48 py-1 bg-cyan lg:flex w-2/3 left-36"
      ></div>
      <div
        class="absolute top-20 flex bg-cyan lg:hidden px-1 right-14/27 mm:right-1/2 h-5/6"
      ></div>
      <stats-card class="mt-16">
        <template #icon>
          <div
            class="lg:ml-5 absolute flex bg-dark-violet px-5 py-5 -top-10 rounded-full"
          >
      ...
      <stats-card class="lg:mt-28 mt-10">
        <template #icon>
          <div
            class="lg:ml-5 absolute flex bg-dark-violet px-5 py-5 -top-10 rounded-full"
          >
      ...
      <stats-card class="lg:mt-40 mt-10">
        <template #icon>
          <div
            class="lg:ml-5 absolute flex bg-dark-violet px-5 py-5 -top-10 rounded-full"
          >
        ...
        <template #text-description>
          ...
          customizable links, supercharging audience engagement.</template
        >
      </stats-card>
    </div>
  </div>
